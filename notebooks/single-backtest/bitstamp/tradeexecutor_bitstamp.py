...
def create_bitstamp_universe(
    ...
    """
    dataset = fetch_bitstamp_dataset(
        symbols,
        candle_time_bucket,
        stop_loss_time_bucket,
        start_at,
